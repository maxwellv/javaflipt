...
//Apparently I wanted Lo-Dash for something, but I seriously don't remember what.
var User;
...
function User(user){
  ...
  this.lifetimeCoins = user.lifetimeCoins ? user.lifetimeCoins : 0;
  this.currentGame = user.currentGame ? user.currentGame : undefined;
}
